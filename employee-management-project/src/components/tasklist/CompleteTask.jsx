...
const CompleteTask = ({data}) => {
  ...
  return (
    <div className="card flex flex-col justify-between rounded-md w-[300px] shrink-0  p-4 bg-green-600 h-full">
      <div>
      ...
      <div className="status flex justify-center">
        <button className="border-none bg-stone-900 py-1 px-2 rounded-sm">Status - <span style={{color:'lightgreen'}}>completed</span></button>
      </div>
    </div>
  );
};
